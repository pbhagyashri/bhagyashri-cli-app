...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{This is an interactive CLI app that let's user explore America's National Parks}

  spec.homepage      = "https://github.com/pbhagyashri/bhagyashri-cli-app"
  spec.license       = "MIT"
